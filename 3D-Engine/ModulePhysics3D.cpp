...
{
	LOGI("Creating 3D Physics simulation");
	bool ret = true;
...
{
	LOGI("Creating Physics environment");
...
{
	LOGI("Destroying 3D Physics simulation");
...
{
	LOGW("Bullet warning: %s", warningString);
}

void DebugDrawer::draw3dText(const btVector3& location, const char* textString)
{
	LOGI("Bullet draw text: %s", textString);
}
